...
class FullTokenizer(object):
    ...
    def __init__(self, vocab = None, vocab_file = None, do_lower_case=True):
        assert vocab is not None or vocab_file is not None
        self.vocab = load_vocab(vocab_file) if vocab is None else vocab
